...
export default function SearchHeaderOptions() {
  ...
  return (
    <div className='flex space-x-2 select-none border-b pb-4 w-full justify-center lg:justify-start lg:pl-48 text-gray-700 text-sm'>
      ...
      <div className={`flex items-center justify-center space-x-1 border-[1.5px] text-xs border-slate-300 hover:bg-gray-200 rounded-3xl active:text-blue-500 cursor-pointer px-3 py-[10px] text-black ${pathname === '/search/map' && '!text-blue-600 !border-0 !bg-blue-100 cursor-text'}`}>
        <p>Maps</p>
      </div>
      <div className={`flex items-center justify-center space-x-1 border-[1.5px] text-xs border-slate-300 hover:bg-gray-200 rounded-3xl active:text-blue-500 cursor-pointer px-3 py-[10px] text-black ${pathname === '/search/map' && '!text-blue-600 !border-0 !bg-blue-100 cursor-text'}`}>
        <p>Books</p>
